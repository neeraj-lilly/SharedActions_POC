...
let packageCLIGit = Package.Dependency.package(
    ...
    .revision("3ed66d8543e87d2ec7b37052513c940b7138def9")
)
...
let package = Package(
    name: "BuildInfoUpdater",
    platforms: [
        .macOS(.v10_12),
    ],
    products: [
        .executable(name: "update-build-info", targets: ["BuildInfoUpdater"])
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "BuildInfoUpdaterTests",
            dependencies: ["BuildInfoUpdater"]
        ),
    ]
)
