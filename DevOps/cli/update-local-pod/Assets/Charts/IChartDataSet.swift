...
public protocol IChartDataSet
{
    ...
    //  [rashmi - May 17]
    /// Modified the file and added a property to return the bool value for showing Circular Dots
    /// This is done to achieve, drawing of Circular Dots on top of each graph point

    //// Set this value to true to show Circular Dots
    var showCircularDotsEnabled : Bool { get set }

    /// - returns: `true` showCircularDotsEnabled  is enabled, `false` ifnot
    var isShowCircularDotsEnabled: Bool { get }
